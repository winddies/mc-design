declare namespace CpeEntity {
    ...
    interface ActivityDetail {
        ...
        config: ActivityConfig.Entity;
        hasLanding?: boolean;
        hitBetMechanismList?: string[];
    ...
    interface IExtendAttr {
        ...
        CoutinuousJoinType: string;
        /** 1：红包，2：其他 */
        ContinuousJoinType: string;
        CoutinuousJoinRound: string;
        /** 总轮数: 3轮 */
        ContinuousJoinRound: string;
        /** 12次/轮 */
